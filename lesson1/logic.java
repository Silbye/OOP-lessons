...
public class Logic {
    ...
    public String getName() {
        String[] names = new String[] { "Back to the Future", "The Green Mile", "Schindler's List",
                "The Shawshank Redemption",
                "Forrest Gump", "The Lord of the Rings: The Return of the King", "Coco", "Interstellar", "Pulp Fiction",
                "The Lion King", "The Dark Knight",
                "Fight Club", "Sen to Chihiro no kamikakushi", "Gladiator", "Sherlock Holmes" };
        return names[rand.nextInt(names.length)];
    }

    public String getCountry() {
        String[] countries = new String[] { "USA", "Canada", "Spain", "Russia", "Soviet Union", "France",
    ...
    public String getStudio() {
        String[] companies = new String[] { "Universal Pictures", "Paramount Pictures", "Warner Bros. Pictures",
                "New Line Cinema", "Walt Disney Pictures",
                "20 Century Studios", "Columbia Pictures", "TriStar Pictures", "Lionsgate Films",
                "Metro-Goldwyn-Mayer Pictures", "Amblin Entertainment", "DreamWorks Pictures" };
        return companies[rand.nextInt(companies.length)];
    }

    public String getGenre() {
        String[] genres = new String[] { "Action", "Adventure", "Comedy", "Drama", "Fantasy", "Horror", "Musical",
                "Mystery", "Sci-fi", "Sports", "Western" };
        return genres[rand.nextInt(genres.length)];
    }

    public String getDirector() {
        String[] directors = new String[] { "Steven Spielberg", "Frank Darabont", "Robert Zemeckis", "Peter Jackson",
                "Christopher Nolan", "Igor Maslennikov",
